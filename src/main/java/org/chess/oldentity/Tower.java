...
public Tower(FigureColor color, Coord coord, Coord maxCoord, Coord minCoord){
this.color = color;
this.coord = coord;
...
int bX = coord.getXCoord() < newCoord.getXCoord() ? 1 : (coord.getXCoord() == newCoord.getXCoord() ? 0 : -1);
int bY = coord.getYCoord() < newCoord.getYCoord() ? 1 : (coord.getYCoord() == newCoord.getYCoord() ? 0 : -1);  
